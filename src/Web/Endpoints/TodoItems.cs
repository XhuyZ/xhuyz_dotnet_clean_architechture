...
using xhuyz_dotnet_clean_architechture.Application.TodoItems.Commands.CreateTodoItem;
using xhuyz_dotnet_clean_architechture.Application.TodoItems.Commands.DeleteTodoItem;
using xhuyz_dotnet_clean_architechture.Application.TodoItems.Commands.UpdateTodoItem;
using xhuyz_dotnet_clean_architechture.Application.TodoItems.Commands.UpdateTodoItemDetail;
using xhuyz_dotnet_clean_architechture.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace xhuyz_dotnet_clean_architechture.Web.Endpoints;
